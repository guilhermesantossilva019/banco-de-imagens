...
<body>
<button type="button" id="consulta" class="btn btn-primary butao"><a href="consulta.php">Consultar</a></button>
<button type="button" class="btn btn-danger butao"><a href="logout.php">Sair</a></button>
